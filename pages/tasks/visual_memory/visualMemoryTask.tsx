...
export default function Page({ taskRef } : any  ) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={taskRef.ref.gridRef} id="grid" className={styles.grid}></div>
      {!started && 
      <div style={{display:'flex', alignSelf:'center', flexDirection:'column', position:'relative', top:'30px'}}>
        ...
        <button ref={taskRef.ref.buttonRef} className={styles.button} onClick={()=>{setStarted(true)}} id="button">
          Start Test
        </button>
      </div>}   
      <p id="status"></p> 
